...
define('game/edit-questions',["exports"], function (exports) {
  ...
  var EditQuestions = exports.EditQuestions = function () {
    ...
    EditQuestions.prototype.addQuestion = function addQuestion() {
      var self = this;
      var questionToCreate = new Question(this.newQuestionText);
  ...
  var Question = exports.Question = function () {
    ...
    Question.prototype.updateQuestions = function updateQuestions() {
      this.editActive = false;
      debugger;
    };
